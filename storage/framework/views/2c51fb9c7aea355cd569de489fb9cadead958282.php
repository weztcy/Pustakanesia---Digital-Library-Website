<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
        <div class="sidebar-brand-icon">
            <img src="<?php echo e(asset('/img/logoPustaka2.png')); ?>">
        </div>
        <div class="sidebar-brand-text mx-3">Pustakanesia</div>
    </a>
...
<?php /**PATH C:\laragon\www\Laravel-perpustakaan\resources\views/part/sidebar.blade.php ENDPATH**/ ?>