...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e('/template/vendor/datatables/jquery.dataTables.min.js'); ?>"></script>
    <script src="<?php echo e('/template/vendor/datatables/dataTables.bootstrap4.min.js'); ?>"></script>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="text-sm text-light h5 mb-0 font-weight-bold"><?php echo e($buku); ?></div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="text-sm text-light h5 mb-0 font-weight-bold"><?php echo e($kategori); ?></div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 mr-3 font-weight-bold text-light"><?php echo e($user); ?></div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 mr-3 font-weight-bold text-light"><?php echo e($jumlah_riwayat); ?></div>
        ...
        <div class="card mb-4">
            <div class="table-responsive p-3">
                <table class="table align-items-center justify-content-center table-flush table-hover" id="dataTableHover" style="font-size:.7rem">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $riwayat_pinjam; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <th scope="row"><?php echo e($loop->iteration); ?></th>
                            <td><?php echo e($item->user->name); ?></td>
                            <td><?php echo e($item->buku->judul); ?></td>
                            <td><?php echo e($item->buku->kode_buku); ?></td>
                            <td><?php echo e($item->tanggal_pinjam); ?></td>
                            <td><?php echo e($item->tanggal_wajib_kembali); ?></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Laravel-perpustakaan\resources\views/AdminDashboard.blade.php ENDPATH**/ ?>